...
package object utils {
  ...
  case class AppContext(kafkaParams: Map[String, Object],
                        ...
                        transformPart: Map[String, TransformPart])
  {
    ...
    def toDataFrame(sqlContext: SQLContext, rdd: RDD[ConsumerRecord[String, GenericRecord]], srcTopic: String ): DataFrame  = {
  ...
  object AppContext {
    def apply(sc: SparkContext, filePath: String): AppContext = {
      ...
      new AppContext(_kafkaParams, _kafkaTopics, _kuduContext, _batchDur, _transformPart)
    }
  }
